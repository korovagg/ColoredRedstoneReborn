...
public class ModItems {
    ...
    /**
     * Helper method to register block item for colored redstone torch.
     * @param name The item name
     * @param torchBlock The standing torch block
     * @param wallTorchBlock The wall torch block
     * @return The registered block item
     */
    private static RegistryObject<Item> registerRedstoneTorch(String name, RegistryObject<Block> torchBlock, RegistryObject<Block> wallTorchBlock) {
        return ITEMS.register(name, () -> new StandingAndWallBlockItem(torchBlock.get(), wallTorchBlock.get(), new Item.Properties(), Direction.DOWN));
    }
    ...
    public static final RegistryObject<Item> WHITE_REDSTONE_TORCH = registerRedstoneTorch("white_redstone_torch", ModBlocks.WHITE_REDSTONE_TORCH, ModBlocks.REDSTONE_WALL_TORCHES.get("white_redstone_torch"));
    public static final RegistryObject<Item> LIGHT_GRAY_REDSTONE_TORCH = registerRedstoneTorch("light_gray_redstone_torch", ModBlocks.LIGHT_GRAY_REDSTONE_TORCH, ModBlocks.REDSTONE_WALL_TORCHES.get("light_gray_redstone_torch"));
    public static final RegistryObject<Item> GRAY_REDSTONE_TORCH = registerRedstoneTorch("gray_redstone_torch", ModBlocks.GRAY_REDSTONE_TORCH, ModBlocks.REDSTONE_WALL_TORCHES.get("gray_redstone_torch"));
    public static final RegistryObject<Item> BLACK_REDSTONE_TORCH = registerRedstoneTorch("black_redstone_torch", ModBlocks.BLACK_REDSTONE_TORCH, ModBlocks.REDSTONE_WALL_TORCHES.get("black_redstone_torch"));
    public static final RegistryObject<Item> BROWN_REDSTONE_TORCH = registerRedstoneTorch("brown_redstone_torch", ModBlocks.BROWN_REDSTONE_TORCH, ModBlocks.REDSTONE_WALL_TORCHES.get("brown_redstone_torch"));
    public static final RegistryObject<Item> ORANGE_REDSTONE_TORCH = registerRedstoneTorch("orange_redstone_torch", ModBlocks.ORANGE_REDSTONE_TORCH, ModBlocks.REDSTONE_WALL_TORCHES.get("orange_redstone_torch"));
    public static final RegistryObject<Item> YELLOW_REDSTONE_TORCH = registerRedstoneTorch("yellow_redstone_torch", ModBlocks.YELLOW_REDSTONE_TORCH, ModBlocks.REDSTONE_WALL_TORCHES.get("yellow_redstone_torch"));
    public static final RegistryObject<Item> LIME_REDSTONE_TORCH = registerRedstoneTorch("lime_redstone_torch", ModBlocks.LIME_REDSTONE_TORCH, ModBlocks.REDSTONE_WALL_TORCHES.get("lime_redstone_torch"));
    public static final RegistryObject<Item> GREEN_REDSTONE_TORCH = registerRedstoneTorch("green_redstone_torch", ModBlocks.GREEN_REDSTONE_TORCH, ModBlocks.REDSTONE_WALL_TORCHES.get("green_redstone_torch"));
    public static final RegistryObject<Item> CYAN_REDSTONE_TORCH = registerRedstoneTorch("cyan_redstone_torch", ModBlocks.CYAN_REDSTONE_TORCH, ModBlocks.REDSTONE_WALL_TORCHES.get("cyan_redstone_torch"));
    public static final RegistryObject<Item> LIGHT_BLUE_REDSTONE_TORCH = registerRedstoneTorch("light_blue_redstone_torch", ModBlocks.LIGHT_BLUE_REDSTONE_TORCH, ModBlocks.REDSTONE_WALL_TORCHES.get("light_blue_redstone_torch"));
    public static final RegistryObject<Item> BLUE_REDSTONE_TORCH = registerRedstoneTorch("blue_redstone_torch", ModBlocks.BLUE_REDSTONE_TORCH, ModBlocks.REDSTONE_WALL_TORCHES.get("blue_redstone_torch"));
    public static final RegistryObject<Item> PURPLE_REDSTONE_TORCH = registerRedstoneTorch("purple_redstone_torch", ModBlocks.PURPLE_REDSTONE_TORCH, ModBlocks.REDSTONE_WALL_TORCHES.get("purple_redstone_torch"));
    public static final RegistryObject<Item> MAGENTA_REDSTONE_TORCH = registerRedstoneTorch("magenta_redstone_torch", ModBlocks.MAGENTA_REDSTONE_TORCH, ModBlocks.REDSTONE_WALL_TORCHES.get("magenta_redstone_torch"));
    public static final RegistryObject<Item> PINK_REDSTONE_TORCH = registerRedstoneTorch("pink_redstone_torch", ModBlocks.PINK_REDSTONE_TORCH, ModBlocks.REDSTONE_WALL_TORCHES.get("pink_redstone_torch"));
