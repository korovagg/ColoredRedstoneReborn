...
public class ColoredRedstoneWallTorchBlock extends RedstoneWallTorchBlock {
    ...
    public ColoredRedstoneWallTorchBlock(Properties settings, int color) {
        super(settings);
    ...
    public void animateTick(BlockState state, Level world, BlockPos pos, RandomSource random) {
        if (state.getValue(LIT)) {
            ...
            world.addParticle(new DustParticleOptions(this.particleColor, 1.0F), d1, d2, d3, 0.0D, 0.0D, 0.0D);
        }
    }
}
