...
public class ModItems {
    ...
    private static Item registerItem(String name, Item item) {
        Item registered = Registry.register(BuiltInRegistries.ITEM, Identifier.fromNamespaceAndPath(ColoredRedstoneFabric.MODID, name), item);
    ...
    private static Item registerRedstoneDust(String name, Block block) {
        ...
        return registerItem(name, new BlockItem(block, new Item.Properties().setId(ResourceKey.create(Registries.ITEM, id))));
    }

    private static Item registerRedstoneBlock(String name, Block block) {
        Identifier id = Identifier.fromNamespaceAndPath(ColoredRedstoneFabric.MODID, name);
        return registerItem(name, new BlockItem(block, new Item.Properties().setId(ResourceKey.create(Registries.ITEM, id)).useBlockDescriptionPrefix()));
    }
    ...
    private static Item registerRedstoneTorch(String name, Block standing, Block wall) {
        Identifier id = Identifier.fromNamespaceAndPath(ColoredRedstoneFabric.MODID, name);
        return registerItem(name, new StandingAndWallBlockItem(standing, wall, Direction.DOWN, new Item.Properties().setId(ResourceKey.create(Registries.ITEM, id)).useBlockDescriptionPrefix()));
    }
