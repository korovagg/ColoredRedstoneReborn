...
public class ModBlocks {
    ...
    private static Block registerRedstoneTorch(String name, MapColor color, int hexColor) {
        ...
        Identifier wallId = Identifier.of(ColoredRedstoneFabric.MODID, wallName);
        Identifier torchId = Identifier.of(ColoredRedstoneFabric.MODID, name);

        Block wall = Registry.register(Registries.BLOCK, wallId, new ColoredRedstoneWallTorchBlock(AbstractBlock.Settings.create()
                .registryKey(RegistryKey.of(RegistryKeys.BLOCK, wallId))
                .mapColor(color)
                .noCollision()
                .breakInstantly()
        ...
        Block block = Registry.register(Registries.BLOCK, torchId, new ColoredRedstoneTorchBlock(AbstractBlock.Settings.create()
                .registryKey(RegistryKey.of(RegistryKeys.BLOCK, torchId))
                .mapColor(color)
                .noCollision()
                .breakInstantly()
                .luminance((state) -> state.get(RedstoneTorchBlock.LIT) ? 7 : 0)
