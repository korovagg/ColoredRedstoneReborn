...
/**
 * Class for initializing and registering all mod items in 1.16.5.
 */
public class ModItems {
    ...
    private static RegistryObject<Item> registerRedstoneDust(String name, RegistryObject<Block> block) {
        return ITEMS.register(name, () -> new BlockNamedItem(block.get(), new Item.Properties().tab(ModCreativeTabs.COLORED_REDSTONE_TAB)));
    }
    ...
    private static RegistryObject<Item> registerRedstoneTorch(String name, RegistryObject<Block> standing, RegistryObject<Block> wall) {
        return ITEMS.register(name, () -> new WallOrFloorItem(standing.get(), wall.get(), new Item.Properties().tab(ModCreativeTabs.COLORED_REDSTONE_TAB)));
    }
